...
class ProfilesSwipingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        profilesList.add(UserProfile("XxMichellexX", "J'adore jouer, je m'appelle michelle, ça rime avec echelle ou nique ta mère Ah ça rime pas ?", "https://i.pinimg.com/originals/1f/ce/37/1fce3791e19f6b1e88349808aa7b3010.jpg"))
        profilesList.add(
            UserProfile(
                "Playeuse",
    ...
    private fun displayNextProfile() {
       val url = profilesList[index].profilePicture
