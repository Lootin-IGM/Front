...
class ChatActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recycler = findViewById<RecyclerView>(R.id.reclyclerChat)
        ...
        val tmpMessage = listOf<Chat>(Chat("yeeees", true), Chat("yeeees", true), Chat("yeeees", true), Chat("yeeees", true), Chat("yeeees", true), Chat("yeeees", true), Chat("yeeees", true), Chat("yeeees", true), Chat("yeeees", true),  Chat("go domac a 19h", false), Chat("ça fera largement l'affaire !!", false), Chat("G 5 euro", true), Chat("ça dépend si tu paies", false),Chat("yo tu baises le premier soir ?", true), Chat("Hello twa", false))
        val adapter = ChatAdapter(tmpMessage, null)
